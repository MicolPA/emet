...
<div class="row">
	<div class="col-lg-8 mb-5">
		<a class="non-style-link text-dark" href="<?php echo base_url('admin/user_detail') ?>">
			<div class="mb-4 p-3 div-bottom-red shadow">
				<span class="display-6 font-weight-bold ">Aprendiendo a estimular</span> 
				<p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quae non magnam expedita possimus facilis placeat. </p>
		...
		<a class="non-style-link text-dark" href="<?php echo base_url('admin/user_detail') ?>">
			<div class="mb-4 p-3 div-bottom-green shadow">
				<span class="display-6 font-weight-bold ">Aprendiendo a estimular</span> 
				<p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quae non magnam expedita possimus facilis placeat. </p>
				<div class="text-right">
					<a class="btn btn-r bg-blue" href="" title="Ver"><i class="fas fa-eye text-white"></i></a>
		...
		<a class="non-style-link text-dark" href="<?php echo base_url('admin/user_detail') ?>">
			<div class="mb-4 p-3 div-bottom-blue shadow">
				<span class="display-6 font-weight-bold ">Aprendiendo a estimular</span> 
				<p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quae non magnam expedita possimus facilis placeat. </p>
				<div class="text-right">
					<a class="btn btn-r bg-blue" href="" title="Ver"><i class="fas fa-eye text-white"></i></a>
